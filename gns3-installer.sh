...
# If your distro uses apt package manager, and you want to attempt to use this script, you need
# to edit a section. To do this run "lsb_release -a 2>/dev/null | grep Codename | cut -f2"
